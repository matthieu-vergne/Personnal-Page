...
class HomePage extends InternalPage {
	...
	public function getContent() {
		...
		$content .= "</div>";
		$content .= "<p>Philosophically speaking, I could be considered shortly as a <a href='https://en.wikipedia.org/wiki/Relativism'>relativist</a>, <a href='https://en.wikipedia.org/wiki/Philosophical_skepticism'>skeptical</a>, <a href='https://en.wikipedia.org/wiki/Perfectionism_(philosophy)'>perfectionist</a>, <a href='https://en.wikipedia.org/wiki/Individualism'>individualist</a>, <a href='https://en.wikipedia.org/wiki/Anarchism'>anarchist</a>, and in particular an <a href='https://en.wikipedia.org/wiki/Epistemological_anarchism'>epistemological anarchist</a>. If you understand that I am a disorganised and rebellious guy who spends his time complaining about everything, I strongly recommend you to carefully read the associated links. I am rather strict in my organisation and methods, seeking for perfection for myself, but extremely open to other perspectives people may have, including brand new or globally rejected ones.</p>";
		$content .= "<p>Regarding my main activity, I am a scientific researcher with a strong interest in intelligence, and in particular in artificial intelligence (A.I.) due to my cursus in Computer Science. Like many, on of my dreams is to implement an artificial agent able to achieve any kind of activities at best of its own resources. For the ones who wonder how a scientist can be a relativist, I would answer that relativism is not <em>against</em> science, but rather <em>includes</em> it: a relativist can take a scientific perspective to write a scientific paper, and keep unscientific positions for other activities. Being an epistemological anarchist also does not mean that I consider globally recognised methods as useless, only that I consider any method as still perfectible (this is consequential to my skeptical side) and that no method should be rejected on the sole behalf of not being a globally accepted one.</p>";
		$content .= "<p>The three citations at the beginning illustrate well my thinking: the first aims at understanding one's own values and capacities, the second establishes incentives for acting towards fulfilling these values through these capacities, and the last one establishes limits to not impair fulfillment for other people. I consider self-improvement as a top ability and every experience and exchange as an opportunity to improve it. So feel free to contact me. {^_°}</p>";
